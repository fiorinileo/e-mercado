...
function showProductInfo() {
  ...
  htmlContentToAppend += `
    ...
    product.cost
                            ...
                            <input type=number id="nudCant" min=1 max=100 value="1">
          ...
          document.getElementById("buy_btn").addEventListener("click",()=>{
            ...
            if (localStorage.getItem("cart")) {
              ...
              if(cart[currentProduct]){
                let cant=cart[currentProduct]+parseInt(document.getElementById("nudCant").value);
                cart[currentProduct]=cant;
                localStorage.setItem("cart", JSON.stringify(cart));
              }
              else{
                cart[currentProduct]=parseInt(document.getElementById("nudCant").value);
                localStorage.setItem("cart", JSON.stringify(cart));
              }
            }
            else{
